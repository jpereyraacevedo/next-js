...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description: "Every asset on our platform is verified by our team to ensure our hightest quality standards. Not happy? We offer a 30-day refund guarantee."
  },
  {
    name: "For the Planet",
    Icon: Leaf,
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Your marketplace for high-quality <span className="text-blue-600">
              digital assets
            </span>.
          </h1>
